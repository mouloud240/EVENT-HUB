...
export class AuthController {
  ...
  async googleRedirect(@Req() req: any, @Res() res: any) {
    ...
    //ADDED FRONTEND URL
    const frontendRedirectUrl = `${this.ConfigService.getOrThrow('FRONTEND_URL')}/login/google-redirect?accessToken=${user.AccessToken}&refreshToken=${user.RefreshToken}`;
